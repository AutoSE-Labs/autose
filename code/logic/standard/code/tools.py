    ...
    for t in [
        ...
        Tool(
            ...
            parameters={
                "path": {
                    "type": "string",
                    "description": "Destination file path. Parent directories are created automatically.",
                },
                "content": {
                    "type": "string",
        ...
        Tool(
            name="run_command",
            description=(
                "Run a shell command when you need to verify something that cannot be done via "
                "file tools (e.g. run a linter, check syntax, inspect build output). "
